...
contract L2StakerDeployer is Script {
    L2Staker l2staker;
    uint256 _tokensToSend = 50 ether;
    ...
    function run() public {
        ...
        address L1deployerAddr = vm.computeCreateAddress(deployer, 2335 + 1);

        vm.startBroadcast(privateKey);
        l2staker = new L2Staker(_tokensToSend, l2oApp, l2oApp_2, L1deployerAddr, endpoint);
        vm.stopBroadcast();
    }
}
