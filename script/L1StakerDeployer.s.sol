...
contract L1StakerDeployer is Script {
    L1Staker l1staker;
    ...
    //     IERC20(SErc20).approve(address(OFTSErc20), type(uint256).max);
    /**
    ...
    function run() public {
        ...
        address L2deployerAddr = vm.computeCreateAddress(deployer, 120 + 1);

        l1staker = new L1Staker(usde, susde, endpoint, oApp, oApp_2, L2deployerAddr);
        // Stop broadcasting
        vm.stopBroadcast();
    }
}
